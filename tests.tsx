...
test("Results", <Results action={{search: dum.function, updateProperties: dum.function}} groupComponent={dum.any} isSelection={dum.boolean} lineComponentMapper={dum.function} renderSingleGroupDecoration={dum.boolean} store={dum.any} totalCount={dum.number} />);
