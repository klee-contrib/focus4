...
import {StoreFacets, AdvancedSearch} from "../../../../store/search/advanced-search";
import {InputFacet, FacetValue} from "../../../../search/search-action/types";

export interface FacetBoxProps {
    facetList: StoreFacets | undefined;
...
export class FacetBox extends React.Component<FacetBoxProps, FacetBoxState> {
    ...
    private generateOpenedFacetList(facetList: StoreFacets) {
