...
describe("EntityStore: Création", () => {
    ...
    it("L'entrée 'operation' a bien la forme attendue", () =>
    ...
    it("L'entrée 'structureList' est bien un array", () => expect(isObservableArray(store.structureList)).toBe(true));
    it("L'entrée 'structureList' possède bien la bonne entité", () =>
        expect(store.structureList.$entity).toEqual(StructureEntity));

    it("'ligneList' de l'entrée 'projet' est bien un array", () =>
        expect(isObservableArray(store.projetTest.ligneList)).toBe(true));
    it("'ligneList' de l'entrée 'projet' possède bien la bonne entité", () =>
        expect(store.projetTest.ligneList.$entity).toEqual(LigneEntity));

    it("Le sous-store est bien accessible", () =>
