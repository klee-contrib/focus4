...
À noter que l'usage de ce module ne vous exempte **pas** de faire toutes les mises à jour liées à la montée de version `mobx-react 9` faite avec la version 12, en particulier :

- Mettre à jour les décorateurs vers la version non expérimentale
- Se débarrasser de tous les usages de `this.props` dans des contextes réactifs
