...
-   Le module `@focus4/forms` contient :
    ...
    -   Les composants d'affichage pour les formulaires ([`Display`](/docs/composants-focus4∕forms-display--docs), [`Label`](/docs/composants-focus4∕forms-label--docs) et [`Panel`](/docs/composants-focus4∕forms-panel--docs))
