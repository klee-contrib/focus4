...
Par défaut, tout message envoyé dans ce store sera transféré au **`MessageCenter`** (posé par le [`Layout`](/docs/mise-en-page-layout--docs) du module `@focus4/layout`, qui les affichera dans
