...
-   Renseigner les [options](/docs/modèle-métier-afficher-des-champs--docs#fieldoptions) `errorDisplay`, `labelRatio`, `valueRatio` et `disableInlineSizing` pour tous les champs posés à l'intérieur.
