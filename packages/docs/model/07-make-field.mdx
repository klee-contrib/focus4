...
Cette méthode est un raccourci pour le `makeField` ci-dessus pour créer un champ (a priori en édition) à partir d'un champ existant, en réutilisant son getter, son setter, ses métadonnées et son domaine.
