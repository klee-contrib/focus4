 ...
 *
 * Il s'agit du [composant par défaut de tous les domaines de type `string` ou `number`](/docs/composants-composants-par-défaut--docs) pour [`fieldFor`](/docs/modèle-métier-afficher-des-champs--docs#fieldforfield-options) (`InputComponent`).
 */
