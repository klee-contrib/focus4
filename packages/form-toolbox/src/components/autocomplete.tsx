 ...
 *
 * Il s'agit du [composant par défaut de tous les domaines de type `string`, `number` et `boolean`](/docs/composants-composants-par-défaut--docs) pour [`autocompleteFor`](/docs/modèle-métier-afficher-des-champs--docs#autocompleteforfield-options) (`AutocompleteComponent`).
 *
