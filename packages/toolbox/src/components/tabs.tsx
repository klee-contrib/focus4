...
const TabContent = forwardRef<RTTabContent, TabContentProps>((props, ref) => {
...
export const Tab: ForwardRefExoticComponent<TabProps & RefAttributes<TabType>> = forwardRef((props, ref) => {
...
export const Tabs = forwardRef<TabsType, TabsProps>((props, ref) => {
